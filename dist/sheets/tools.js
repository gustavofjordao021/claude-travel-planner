...
import { getSheetTitle, getSheetId, columnLetterToIndex, validateArgs, } from "./helpers.js";
...
export async function refreshAuth() {
    try {
        ...
        const credentials = JSON.parse(fs.readFileSync(process.env.GSHEETS_CREDENTIALS_PATH ||
            ".gsheets-server-credentials.json", "utf-8"));
...
export async function createSpreadsheet(args) {
    try {
        const validArgs = validateArgs(args, ["title"]);
...
export async function listSheets(args) {
    try {
        const validArgs = validateArgs(args, ["spreadsheetId"]);
 ...
 */
export async function readAllFromSheet(args) {
    try {
        const validArgs = validateArgs(args, ["spreadsheetId"]);
        const { spreadsheetId, sheetName } = validArgs;
 ...
 */
export async function readHeadings(args) {
    try {
        const validArgs = validateArgs(args, ["spreadsheetId"]);
        const { spreadsheetId, sheetName } = validArgs;
        const title = await getSheetTitle(spreadsheetId, sheetName);
 ...
 */
export async function readRows(args) {
    try {
        const validArgs = validateArgs(args, [
            "spreadsheetId",
            "startRow",
 ...
 */
export async function editCell(args) {
    try {
        const validArgs = validateArgs(args, [
            "spreadsheetId",
            "cellAddress",
 ...
 */
export async function editRow(args) {
    try {
        const validArgs = validateArgs(args, [
            "spreadsheetId",
            "rowIndex",
 ...
 */
export async function editColumn(args) {
    try {
        const validArgs = validateArgs(args, [
            "spreadsheetId",
            "columnLetter",
 ...
 */
export async function insertColumn(args) {
    try {
        const validArgs = validateArgs(args, [
            "spreadsheetId",
            "columnLetter",
 ...
 */
export async function renameDoc(args) {
    try {
        const validArgs = validateArgs(args, [
            "spreadsheetId",
            "newName",
