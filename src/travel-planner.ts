	...
	return {
		tools: [
				...
				inputSchema: {
					...
					properties: {
						...
						initialSheetName: {
							type: "string",
							description:
								"The name of the initial sheet, defaults to 'Itinerary'.",
						},
					},
					required: ["title"],
				},
			...
			},
			{
				...
				description:
					"Read all data from a specified sheet in a Google Spreadsheet",
				inputSchema: {
					type: "object",
					properties: {
						spreadsheetId: {
						...
						sheetName: {
							type: "string",
							description:
								"The name of the sheet to read from. If not provided, reads from the first sheet.",
						},
					},
					required: ["spreadsheetId"],
				},
				...
				inputSchema: {
					...
					properties: {
						...
						startRowIndex: {
							type: "integer",
							description:
								"The 0-based row index to start reading from. Default is 0.",
						},
						endRowIndex: {
							type: "integer",
							description:
								"The 0-based row index to end reading at (exclusive). Default is to read to the end.",
						},
					},
					required: ["spreadsheetId"],
				},
				...
				inputSchema: {
					...
					properties: {
						...
						startColumnIndex: {
							type: "integer",
							description:
								"The 0-based column index to start reading from. Default is 0.",
						},
						endColumnIndex: {
							type: "integer",
							description:
								"The 0-based column index to end reading at (exclusive). Default is to read to the end.",
						},
					},
					required: ["spreadsheetId"],
				},
				...
				inputSchema: {
					...
					properties: {
						...
						sheetName: {
							type: "string",
							description:
								"The name of the sheet to edit. If not provided, edits the first sheet.",
						},
						rowIndex: {
							type: "integer",
				...
				inputSchema: {
					...
					properties: {
						...
						rowIndex: {
							type: "integer",
							description:
								"The 0-based row index where the new row should be inserted. The new row will be inserted before this index.",
						},
						values: {
							type: "array",
							items: {
				...
				inputSchema: {
					...
					properties: {
						...
						columnIndex: {
							type: "integer",
							description:
								"The 0-based column index where the new column should be inserted. The new column will be inserted before this index.",
						},
						values: {
							type: "array",
							items: {
				...
				inputSchema: {
					...
					properties: {
						location: {
							type: "string",
							description:
								"Location as 'lat,lng' coordinates or an address string.",
						},
						radius: {
							type: "integer",
						...
						type: {
							type: "string",
							description:
								"Type of place (e.g., 'restaurant', 'tourist_attraction', 'hotel').",
						},
						keyword: {
							type: "string",
				...
				inputSchema: {
					...
					properties: {
						origins: {
							type: "string",
							description:
								"Starting location(s) as address or 'lat,lng' coordinates.",
						},
						destinations: {
							type: "string",
							description:
								"Destination location(s) as address or 'lat,lng' coordinates.",
						},
						mode: {
							type: "string",
							description:
								"Travel mode: 'driving', 'walking', 'bicycling', or 'transit'. Default is 'driving'.",
						},
					},
				...
				inputSchema: {
					...
					properties: {
						origin: {
							type: "string",
							description:
								"Starting location as address or 'lat,lng' coordinates.",
						},
						destination: {
							type: "string",
							description:
								"Destination location as address or 'lat,lng' coordinates.",
						},
						mode: {
							type: "string",
							description:
						...
						waypoints: {
							type: "string",
							description:
								"Optional waypoints separated by '|' for multiple stops along the route.",
						},
					},
				...
				inputSchema: {
					...
					properties: {
						...
						timestamp: {
							type: "integer",
							description:
								"Optional timestamp to check timezone information for a specific time (Unix seconds).",
						},
					},
					required: ["location"],
				},
	...
	try {
		switch (name) {
			case "create_spreadsheet": {
				try {
					const result = await sheetTools.createSpreadsheet(
			...
			case "list_sheets": {
				try {
					const result = await sheetTools.listSheets(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "create_sheet": {
				try {
					const result = await sheetTools.createSheet(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "read_all_from_sheet": {
				try {
					const result = await sheetTools.readAllFromSheet(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "read_headings": {
				try {
					const result = await sheetTools.readHeadings(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "read_rows": {
				try {
					const result = await sheetTools.readRows(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "read_columns": {
				try {
					const result = await sheetTools.readColumns(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "edit_cell": {
				try {
					const result = await sheetTools.editCell(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "edit_row": {
				try {
					const result = await sheetTools.editRow(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "edit_column": {
				try {
					const result = await sheetTools.editColumn(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "insert_row": {
				try {
					const result = await sheetTools.insertRow(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "insert_column": {
				try {
					const result = await sheetTools.insertColumn(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "rename_sheet": {
				try {
					const result = await sheetTools.renameSheet(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "rename_doc": {
				try {
					const result = await sheetTools.renameDoc(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "geocode": {
				try {
					const result = await mapsTools.geocode(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "places_nearby": {
				try {
					const result = await mapsTools.placesNearby(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "timezone": {
				try {
					const result = await mapsTools.timezone(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "distance_matrix": {
				try {
					const result = await mapsTools.distanceMatrix(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "directions": {
				try {
					const result = await mapsTools.directions(
						args as Record<string, unknown>
					);
					return {
						content: [
			...
			case "convert_currency": {
				try {
					const result = await mapsTools.convertCurrency(
						args as Record<string, unknown>
					);
					return {
						content: [
...
const httpServer = createServer((req, res) => {
	res.writeHead(200);
	res.end("Travel Planner MCP Server Running");
});
